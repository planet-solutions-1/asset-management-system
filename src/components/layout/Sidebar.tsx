            ...
            <aside className={clsx(
                ...
                <div className="p-8 h-full flex flex-col">
                    ...
                    <div className="flex items-center gap-3 px-2 mb-8 hidden lg:flex">
                        ...
                        <span className="text-xl font-bold text-white tracking-tight">Asset.Sys</span>
                    </div>

                    <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4 px-2">Overview</p>
                            ...
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    clsx(
                                        ...
                                        isActive
                                            ? 'bg-blue-600/20 text-blue-400 shadow-sm backdrop-blur-md border border-blue-500/30'
                    ...
                    <div className="mt-auto pt-6 border-t border-white/10 lg:hidden">
                        <div className="flex items-center gap-3 px-2">
                            <div className="w-10 h-10 rounded-full bg-blue-900/50 flex items-center justify-center text-blue-400 font-bold text-sm border border-blue-500/30">
